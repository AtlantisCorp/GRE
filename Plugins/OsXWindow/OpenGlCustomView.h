...
/// @brief A Custom OpenGl view in order to manage NSOpenGlContext from CGLContext.
/// CGLContext are created using the OpenGl Renderer. Those context are linked to the
/// Window which should set the context using the View's methods.
